<template>
  ...
  <div>
        ID: <input type="text" name="" id="id" v-model="id" /><br /><br />  
        ...
        <button @click="putApartamento"> Editar Apartamento </button><br /><br />
  ...
  methods: {
   ...
   putApartamento: function() {
      ...
      this.$http.put(this.baseURI + "/" + this.id, obj).then((result) => {
        ...
        alert("Apartamento editado com sucesso!");
      });
    }
    },
    },
